                            ...
                            <Row>
                                ...
                                <Col md={6} lg={4} className="total d-flex flex-column justify-content-end">
                                    <Row>
                                        ...
                                        <Col xs={12} className="dollar-value text-right text-secondary">~{numbro(this.state.total/Meteor.settings.public.stakingFraction*this.state.price).format("$0,0.0000a")} ({numbro(this.state.price).format("$0,0.00")}/SPEND)</Col>
                                    </Row>
                                </Col>
                            </Row>
                        </CardBody>
